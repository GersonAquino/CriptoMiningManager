namespace CryptoMiningManager.Views.UserControls.Configuracoes.Editores
{
    partial class MineradorEditorUserControl
    {
		...
		private void InitializeComponent()
		{
			...
			CPUCheckEdit = new DevExpress.XtraEditors.CheckEdit();
			GPUCheckEdit = new DevExpress.XtraEditors.CheckEdit();
			ConsumoMedioSpinEdit = new DevExpress.XtraEditors.SpinEdit();
			...
			ItemForConsumoMedio = new DevExpress.XtraLayout.LayoutControlItem();
			ItemForGPU = new DevExpress.XtraLayout.LayoutControlItem();
			ItemForParametros = new DevExpress.XtraLayout.LayoutControlItem();
			ItemForCPU = new DevExpress.XtraLayout.LayoutControlItem();
			...
			((System.ComponentModel.ISupportInitialize)CPUCheckEdit.Properties).BeginInit();
			((System.ComponentModel.ISupportInitialize)GPUCheckEdit.Properties).BeginInit();
			((System.ComponentModel.ISupportInitialize)ConsumoMedioSpinEdit.Properties).BeginInit();
			...
			((System.ComponentModel.ISupportInitialize)ItemForConsumoMedio).BeginInit();
			((System.ComponentModel.ISupportInitialize)ItemForGPU).BeginInit();
			((System.ComponentModel.ISupportInitialize)ItemForParametros).BeginInit();
			((System.ComponentModel.ISupportInitialize)ItemForCPU).BeginInit();
			((System.ComponentModel.ISupportInitialize)ItemForDataAlteracao).BeginInit();
			SuspendLayout();
			// 
			// MineradorEditorRC
			// 
			MineradorEditorRC.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(30, 31, 30, 31);
			...
			MineradorEditorRC.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			MineradorEditorRC.Size = new System.Drawing.Size(1196, 173);
			// 
			// GravarBBI
			// 
			...
			// MineradorDLC
			// 
			MineradorDLC.BackColor = System.Drawing.Color.Transparent;
			...
			MineradorDLC.Controls.Add(CPUCheckEdit);
			MineradorDLC.Controls.Add(GPUCheckEdit);
			MineradorDLC.Controls.Add(ConsumoMedioSpinEdit);
			...
			MineradorDLC.Location = new System.Drawing.Point(0, 173);
			MineradorDLC.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			MineradorDLC.MenuManager = MineradorEditorRC;
			MineradorDLC.Name = "MineradorDLC";
			MineradorDLC.Root = MineradorLCG;
			MineradorDLC.Size = new System.Drawing.Size(1196, 457);
			...
			AtivoCheckEdit.Location = new System.Drawing.Point(600, 86);
			...
			AtivoCheckEdit.Size = new System.Drawing.Size(584, 20);
			AtivoCheckEdit.StyleController = MineradorDLC;
			AtivoCheckEdit.TabIndex = 5;
			// 
			...
			DataCriacaoDateEdit.Location = new System.Drawing.Point(139, 90);
			...
			DataCriacaoDateEdit.Size = new System.Drawing.Size(457, 22);
			DataCriacaoDateEdit.StyleController = MineradorDLC;
			DataCriacaoDateEdit.TabIndex = 6;
			// 
			...
			DataAlteracaoDateEdit.Location = new System.Drawing.Point(139, 116);
			...
			DataAlteracaoDateEdit.Size = new System.Drawing.Size(457, 22);
			DataAlteracaoDateEdit.StyleController = MineradorDLC;
			DataAlteracaoDateEdit.TabIndex = 7;
			// 
			...
			LocalizacaoButtonEdit.Location = new System.Drawing.Point(139, 38);
			LocalizacaoButtonEdit.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			LocalizacaoButtonEdit.Size = new System.Drawing.Size(457, 22);
			LocalizacaoButtonEdit.StyleController = MineradorDLC;
			LocalizacaoButtonEdit.TabIndex = 0;
			...
			NomeTextEdit.Location = new System.Drawing.Point(139, 12);
			NomeTextEdit.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			NomeTextEdit.MenuManager = MineradorEditorRC;
			NomeTextEdit.Name = "NomeTextEdit";
			NomeTextEdit.Size = new System.Drawing.Size(457, 22);
			NomeTextEdit.StyleController = MineradorDLC;
			NomeTextEdit.TabIndex = 9;
			// 
			// ParametrosMemoEdit
			// 
			ParametrosMemoEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", MineradorBindingSource, "Parametros", true));
			ParametrosMemoEdit.Location = new System.Drawing.Point(12, 159);
			ParametrosMemoEdit.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			ParametrosMemoEdit.MenuManager = MineradorEditorRC;
			ParametrosMemoEdit.Name = "ParametrosMemoEdit";
			ParametrosMemoEdit.Size = new System.Drawing.Size(1172, 64);
			ParametrosMemoEdit.StyleController = MineradorDLC;
			ParametrosMemoEdit.TabIndex = 8;
			// 
			...
			MoedaSearchLookUpEdit.Location = new System.Drawing.Point(727, 12);
			MoedaSearchLookUpEdit.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			MoedaSearchLookUpEdit.Size = new System.Drawing.Size(457, 22);
			MoedaSearchLookUpEdit.StyleController = MineradorDLC;
			MoedaSearchLookUpEdit.TabIndex = 10;
			// 
			// MoedasBindingSource
			// 
			...
			// CPUCheckEdit
			// 
			CPUCheckEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", MineradorBindingSource, "CPU", true));
			CPUCheckEdit.Location = new System.Drawing.Point(600, 62);
			CPUCheckEdit.MenuManager = MineradorEditorRC;
			CPUCheckEdit.Name = "CPUCheckEdit";
			CPUCheckEdit.Properties.Caption = "CPU";
			CPUCheckEdit.Properties.GlyphAlignment = DevExpress.Utils.HorzAlignment.Default;
			CPUCheckEdit.Size = new System.Drawing.Size(584, 20);
			CPUCheckEdit.StyleController = MineradorDLC;
			CPUCheckEdit.TabIndex = 3;
			// 
			// GPUCheckEdit
			// 
			GPUCheckEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", MineradorBindingSource, "GPU", true));
			GPUCheckEdit.Location = new System.Drawing.Point(600, 38);
			GPUCheckEdit.MenuManager = MineradorEditorRC;
			GPUCheckEdit.Name = "GPUCheckEdit";
			GPUCheckEdit.Properties.Caption = "GPU";
			GPUCheckEdit.Properties.GlyphAlignment = DevExpress.Utils.HorzAlignment.Default;
			GPUCheckEdit.Size = new System.Drawing.Size(584, 20);
			GPUCheckEdit.StyleController = MineradorDLC;
			GPUCheckEdit.TabIndex = 2;
			// 
			// ConsumoMedioSpinEdit
			// 
			ConsumoMedioSpinEdit.DataBindings.Add(new System.Windows.Forms.Binding("EditValue", MineradorBindingSource, "ConsumoMedio", true));
			ConsumoMedioSpinEdit.EditValue = new decimal(new int[] { 0, 0, 0, 0 });
			ConsumoMedioSpinEdit.Location = new System.Drawing.Point(139, 64);
			ConsumoMedioSpinEdit.MenuManager = MineradorEditorRC;
			ConsumoMedioSpinEdit.Name = "ConsumoMedioSpinEdit";
			ConsumoMedioSpinEdit.Properties.AllowNullInput = DevExpress.Utils.DefaultBoolean.True;
			ConsumoMedioSpinEdit.Properties.Appearance.Options.UseTextOptions = true;
			ConsumoMedioSpinEdit.Properties.Appearance.TextOptions.HAlignment = DevExpress.Utils.HorzAlignment.Far;
			ConsumoMedioSpinEdit.Properties.Buttons.AddRange(new DevExpress.XtraEditors.Controls.EditorButton[] { new DevExpress.XtraEditors.Controls.EditorButton(DevExpress.XtraEditors.Controls.ButtonPredefines.Combo) });
			ConsumoMedioSpinEdit.Properties.EditValueChangedFiringMode = DevExpress.XtraEditors.Controls.EditValueChangedFiringMode.Default;
			ConsumoMedioSpinEdit.Properties.Mask.UseMaskAsDisplayFormat = true;
			ConsumoMedioSpinEdit.Properties.MaskSettings.Set("mask", "G");
			ConsumoMedioSpinEdit.Properties.MaxValue = new decimal(new int[] { 100000, 0, 0, 0 });
			ConsumoMedioSpinEdit.Size = new System.Drawing.Size(457, 22);
			ConsumoMedioSpinEdit.StyleController = MineradorDLC;
			ConsumoMedioSpinEdit.TabIndex = 11;
			// 
			// MineradorLCG
			// 
			MineradorLCG.AllowDrawBackground = false;
			...
			MineradorLCG.Size = new System.Drawing.Size(1196, 457);
			MineradorLCG.TextVisible = false;
			// 
			// layoutControlGroup1
			// 
			layoutControlGroup1.GroupBordersVisible = false;
			layoutControlGroup1.Items.AddRange(new DevExpress.XtraLayout.BaseLayoutItem[] { ItemForLocalizacao, ItemForDataCriacao, ItemForAtivo, emptySpaceItem1, ItemForConsumoMedio, ItemForGPU, ItemForParametros, ItemForCPU, ItemForDataAlteracao, ItemForNome, ItemForMoeda });
			layoutControlGroup1.Location = new System.Drawing.Point(0, 0);
			layoutControlGroup1.Name = "autoGeneratedGroup0";
			layoutControlGroup1.Size = new System.Drawing.Size(1176, 437);
			// 
			// ItemForLocalizacao
			// 
			ItemForLocalizacao.Control = LocalizacaoButtonEdit;
			ItemForLocalizacao.Location = new System.Drawing.Point(0, 26);
			ItemForLocalizacao.Name = "ItemForLocalizacao";
			ItemForLocalizacao.Size = new System.Drawing.Size(588, 26);
			ItemForLocalizacao.Text = "Localização";
			ItemForLocalizacao.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForDataCriacao
			// 
			ItemForDataCriacao.Control = DataCriacaoDateEdit;
			ItemForDataCriacao.Location = new System.Drawing.Point(0, 78);
			...
			ItemForDataCriacao.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForAtivo
			// 
			ItemForAtivo.Control = AtivoCheckEdit;
			ItemForAtivo.Location = new System.Drawing.Point(588, 74);
			ItemForAtivo.Name = "ItemForAtivo";
			ItemForAtivo.Size = new System.Drawing.Size(588, 56);
			...
			emptySpaceItem1.Location = new System.Drawing.Point(0, 215);
			emptySpaceItem1.Name = "emptySpaceItem1";
			emptySpaceItem1.Size = new System.Drawing.Size(1176, 222);
			...
			ItemForNome.Size = new System.Drawing.Size(588, 26);
			ItemForNome.Text = "Nome";
			ItemForNome.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForMoeda
			// 
			ItemForMoeda.Control = MoedaSearchLookUpEdit;
			ItemForMoeda.Location = new System.Drawing.Point(588, 0);
			ItemForMoeda.Name = "ItemForMoeda";
			ItemForMoeda.Size = new System.Drawing.Size(588, 26);
			ItemForMoeda.Text = "Moeda";
			ItemForMoeda.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForConsumoMedio
			// 
			ItemForConsumoMedio.Control = ConsumoMedioSpinEdit;
			ItemForConsumoMedio.Location = new System.Drawing.Point(0, 52);
			ItemForConsumoMedio.Name = "ItemForConsumoMedio";
			ItemForConsumoMedio.Size = new System.Drawing.Size(588, 26);
			ItemForConsumoMedio.Text = "Consumo Médio (Watts)";
			ItemForConsumoMedio.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForGPU
			// 
			ItemForGPU.Control = GPUCheckEdit;
			ItemForGPU.Location = new System.Drawing.Point(588, 26);
			ItemForGPU.Name = "ItemForGPU";
			ItemForGPU.Size = new System.Drawing.Size(588, 24);
			ItemForGPU.Text = "GPU";
			ItemForGPU.TextSize = new System.Drawing.Size(0, 0);
			ItemForGPU.TextVisible = false;
			// 
			// ItemForParametros
			// 
			ItemForParametros.Control = ParametrosMemoEdit;
			ItemForParametros.Location = new System.Drawing.Point(0, 130);
			ItemForParametros.Name = "ItemForParametros";
			ItemForParametros.Size = new System.Drawing.Size(1176, 85);
			ItemForParametros.Text = "Parâmetros";
			ItemForParametros.TextLocation = DevExpress.Utils.Locations.Top;
			ItemForParametros.TextSize = new System.Drawing.Size(115, 13);
			// 
			// ItemForCPU
			// 
			ItemForCPU.Control = CPUCheckEdit;
			ItemForCPU.Location = new System.Drawing.Point(588, 50);
			ItemForCPU.Name = "ItemForCPU";
			ItemForCPU.Size = new System.Drawing.Size(588, 24);
			ItemForCPU.Text = "CPU";
			ItemForCPU.TextSize = new System.Drawing.Size(0, 0);
			ItemForCPU.TextVisible = false;
			// 
			// ItemForDataAlteracao
			// 
			ItemForDataAlteracao.Control = DataAlteracaoDateEdit;
			ItemForDataAlteracao.Location = new System.Drawing.Point(0, 104);
			...
			ItemForDataAlteracao.TextSize = new System.Drawing.Size(115, 13);
			// 
			...
			((System.ComponentModel.ISupportInitialize)CPUCheckEdit.Properties).EndInit();
			((System.ComponentModel.ISupportInitialize)GPUCheckEdit.Properties).EndInit();
			((System.ComponentModel.ISupportInitialize)ConsumoMedioSpinEdit.Properties).EndInit();
			...
			((System.ComponentModel.ISupportInitialize)ItemForConsumoMedio).EndInit();
			((System.ComponentModel.ISupportInitialize)ItemForGPU).EndInit();
			((System.ComponentModel.ISupportInitialize)ItemForParametros).EndInit();
			((System.ComponentModel.ISupportInitialize)ItemForCPU).EndInit();
		...
		private DevExpress.XtraEditors.CheckEdit CPUCheckEdit;
		private DevExpress.XtraEditors.CheckEdit GPUCheckEdit;
		private DevExpress.XtraLayout.LayoutControlItem ItemForConsumoMedio;
		private DevExpress.XtraLayout.LayoutControlItem ItemForGPU;
		private DevExpress.XtraLayout.LayoutControlItem ItemForCPU;
		private DevExpress.XtraEditors.SpinEdit ConsumoMedioSpinEdit;
	}
}
