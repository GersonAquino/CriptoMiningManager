namespace CriptoMiningManager.Views.UserControls.Configuracoes
{
    partial class MoedasUserControl
    {
		...
		private void InitializeComponent()
		{
			...
			MoedasGC.EmbeddedNavigator.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			MoedasGC.Location = new System.Drawing.Point(0, 173);
			MoedasGC.MainView = MoedasGV;
			MoedasGC.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			MoedasGC.Name = "MoedasGC";
			MoedasGC.RepositoryItems.AddRange(new DevExpress.XtraEditors.Repository.RepositoryItem[] { NomeRITE });
			MoedasGC.Size = new System.Drawing.Size(1234, 421);
			MoedasGC.TabIndex = 1;
			...
			colBtcPorDia.Width = 93;
			// 
			// MoedasRC
			// 
			MoedasRC.EmptyAreaImageOptions.ImagePadding = new System.Windows.Forms.Padding(30, 31, 30, 31);
			...
			MoedasRC.Margin = new System.Windows.Forms.Padding(3, 2, 3, 2);
			...
			MoedasRC.Size = new System.Drawing.Size(1234, 173);
			// 
			// AtualizarBBI
			// 
